...
# =================================================================================
  ...
  Scenario: Enviar petición "POST" - "/comunicaciones/registro-por-incidencia" con datos válidos
    ...
    And uso el cuerpo de registro externo llamado "JSON_VALIDO_RI_CON_ANEXOS" como campo "registroComunicacionRequest"
  ...
  Scenario Outline: Validar "POST" - "/comunicaciones/registro-por-incidencia" con datos válidos y distintos token
    ...
    And uso el cuerpo de registro externo llamado "JSON_MINIMO_VALIDO_RI" como campo "registroComunicacionRequest"
  ...
  Scenario: Validar "POST" - "/comunicaciones/registro-por-incidencia" con 'archivosAnexos' valido y sin 'archivosAnexosInfo' en JSON registroComunicacionRequest
    Given que preparo una petición "POST" a "/comunicaciones/registro-por-incidencia" con token "válido"
    And uso el cuerpo de registro externo llamado "JSON_MINIMO_VALIDO_RI" como campo "registroComunicacionRequest"
    And adjunto un archivo valido "2_FIRMANTES_EN_DOC_DIGITAL.pdf" como "documentoPrincipal"
    And adjunto un archivo valido "ACEPTA.pdf" como "archivosAnexos"
  ...
  Scenario: Validar "POST" - "/comunicaciones/registro-por-incidencia" con 'archivosAnexos' valido y sin datos en 'archivosAnexosInfo' en JSON registroComunicacionRequest
    Given que preparo una petición "POST" a "/comunicaciones/registro-por-incidencia" con token "válido"
    And uso el cuerpo de registro externo llamado "JSON_VALIDO_RI_CON_ANEXOS_VACIOS" como campo "registroComunicacionRequest"
    And adjunto un archivo valido "2_FIRMANTES_EN_DOC_DIGITAL.pdf" como "documentoPrincipal"
    And adjunto un archivo valido "ACEPTA.pdf" como "archivosAnexos"
    When envío la petición multipart de registro externo
    Then el estado de la respuesta debe ser 400
  ...
  Scenario: Validar "POST" - "/comunicaciones/registro-por-incidencia" sin 'archivosAnexos' y con 'archivosAnexosInfo' valido en JSON registroComunicacionRequest
    Given que preparo una petición "POST" a "/comunicaciones/registro-por-incidencia" con token "válido"
    And uso el cuerpo de registro externo llamado "JSON_VALIDO_RI_CON_ANEXOS" como campo "registroComunicacionRequest"
    And adjunto un archivo valido "2_FIRMANTES_EN_DOC_DIGITAL.pdf" como "documentoPrincipal"
    When envío la petición multipart de registro externo
  ...
  Scenario Outline: Validar cada campo del JSON 'registroComunicacionRequest'
    ...
    Examples: Campos que fallan validación (400 - Validation failure)
      ...
      | JSON_RI_SIN_IS_EN_COPIA_DESTINATARIOS_CONFIGURACION_DESTINATARIOS                               | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
      | JSON_RI_SIN_IS_EN_COPIA_DESTINATARIOS_CONFIGURACION_DESTINATARIOS_ARRAY                         | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
      ...
      | JSON_RI_SIN_PLATAFORMA_DESPACHO_EXTERNO                                                         | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
  ...
  Scenario Outline: Validar regla de nombre de archivos anexos en el JSON 'registroComunicacionRequest'
    ...
    Examples: Campos que fallan validación (400 - Validation failure)
      ...
      | JSON_CON_ARCHIVOS_ANEXOS_FILENAME_CORTO_RI | ab.pdf                                                                                                                                                      | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
  ...
  Scenario Outline: Validar tipos de datos en JSON 'registroComunicacionRequest' (cada campo del JSON)
    ...
    Examples:
      ...
      | JSON_RI_FOLIO_STRING_A_STRING_CARACTER_ESPECIAL                                              | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
      | JSON_RI_FOLIO_STRING_A_INTEGER                                                               | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
      | JSON_RI_FOLIO_STRING_A_BOOLEAN                                                               | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
      ...
      | JSON_RI_ID_TIPO_DOCUMENTO_OFICIAL_INTEGER_A_STRING                                           | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
      ...
      | JSON_RI_MATERIA_STRING_A_NUMBER                                                              | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
      | JSON_RI_MATERIA_STRING_A_STRING_CARACTER_ESPECIAL                                            | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
      | JSON_RI_MATERIA_STRING_A_BOOLEAN                                                             | ERROR_400_Bad_Request | "message"   | "Petición no válida."  |
